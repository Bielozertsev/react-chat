...
export const SOCKETS_СONNECTION_SUCCESS = Symbol('sockets/SOCKETS_СONNECTION_SUCCESS');
export const SOCKETS_СONNECTION_FAILURE = Symbol('sockets/SOCKETS_СONNECTION_FAILURE');
